...
public abstract class BaseSpringWebApplication {
    ...
    protected void initialize() throws URISyntaxException {
        ...
        SpringServlet httpServlet=new SpringServlet();
        restServlet = context.addServlet("spring",httpServlet);
        restServlet.addMapping("/*");

        server = new HttpServer();
        NetworkListener listener = new NetworkListener(applicationName(), hostName(), 8090);
